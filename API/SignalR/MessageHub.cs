...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            // OJO: debe coincidir el nombre con message.service.ts del front
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            // si los dos están conectados y viendo simultaneamente el tab de messages en 
            // el front, automaticamente establece la fecha de lectura.
            ...
            {
                // de lo contrario, si, el usuario está online, enviarle una notificacion.
                var connections = await _tracker.GetConnectionsForUser(recipient.UserName.ToLower());
                if (connections != null)
                {
                    // envia notificacion a todas las instancias a las que esté conectado el usuario
                    await _presenceHub.Clients.Clients(connections).SendAsync("NewMessageReceived",
                            new { username = sender.UserName.ToLower(), knownAs = sender.KnownAs });
                }
            }
        ...
        {
            // si 'other' es mas grande que 'caller', es < cero.
